...
def sendMail(mail_address="user@gmail.com", username="user", date="29/09/2024 - 17:14:27",admin_name = "",
             subject="CineLib Giriş Doğrulama", verification_code="052486", reference_code="",
             reason = "Doğrulama", is_default = True):

    admin = 'APP_MAIL_ADDRESS'
