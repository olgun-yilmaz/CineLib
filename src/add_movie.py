...
from src.app_module import icon_folder, conn, cursor, CustomizeMessageBox, customize_widget

from PyQt5.QtCore import QSize, Qt, QRect, QTimer
from PyQt5.QtGui import QIcon, QIntValidator, QTextCursor, QPixmap
from PyQt5.QtWidgets import (QPushButton, QLineEdit, QLabel, QMessageBox, QTextEdit, QDialog,QVBoxLayout,
                             QHBoxLayout, QListWidgetItem, QListWidget, QAbstractItemView)
